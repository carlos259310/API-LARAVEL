...
@section('content')
<div class="container-fluid" data-ciudades="{{ json_encode($ciudades) }}" data-cliente-id="{{ $cliente->id }}" data-cliente-ciudad="{{ $cliente->id_ciudad }}">
    <div class="row">
        <div class="col-12">
            ...
            <div class="card shadow">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Editar Información del Cliente #{{ $cliente->id }}</h6>
                </div>
                <div class="card-body">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('nombre_1') is-invalid @enderror" 
                                               id="nombre_1" name="nombre_1" value="{{ old('nombre_1', $cliente->nombre_1) }}" required>
                                        @error('nombre_1')
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('nombre_2') is-invalid @enderror" 
                                               id="nombre_2" name="nombre_2" value="{{ old('nombre_2', $cliente->nombre_2) }}">
                                        @error('nombre_2')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('apellido_1') is-invalid @enderror" 
                                               id="apellido_1" name="apellido_1" value="{{ old('apellido_1', $cliente->apellido_1) }}" required>
                                        @error('apellido_1')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('apellido_2') is-invalid @enderror" 
                                               id="apellido_2" name="apellido_2" value="{{ old('apellido_2', $cliente->apellido_2) }}">
                                        @error('apellido_2')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-control @error('id_tipo_documento') is-invalid @enderror" 
                                            ...
                                            @foreach($tiposDocumento as $tipo)
                                                <option value="{{ $tipo->id }}" {{ old('id_tipo_documento', $cliente->id_tipo_documento) == $tipo->id ? 'selected' : '' }}>
                                                    {{ $tipo->nombre }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('numero_documento') is-invalid @enderror" 
                                               id="numero_documento" name="numero_documento" value="{{ old('numero_documento', $cliente->numero_documento) }}" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control @error('tipo_cliente') is-invalid @enderror" 
                                        ...
                                        <option value="">Seleccionar...</option>
                                        <option value="natural" {{ old('tipo_cliente', $cliente->tipo_cliente) == 'natural' ? 'selected' : '' }}>Natural</option>
                                        <option value="juridico" {{ old('tipo_cliente', $cliente->tipo_cliente) == 'juridico' ? 'selected' : '' }}>Jurídico</option>
                                    </select>
                                    @error('tipo_cliente')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3 @if(old('tipo_cliente', $cliente->tipo_cliente) != 'juridico') d-none @endif" id="razon_social_group">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control @error('id_departamento') is-invalid @enderror" 
                                        ...
                                        @foreach($departamentos as $departamento)
                                            <option value="{{ $departamento->id }}" {{ old('id_departamento', $cliente->id_departamento) == $departamento->id ? 'selected' : '' }}>
                                                {{ $departamento->nombre }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control @error('id_ciudad') is-invalid @enderror" 
                                        ...
                                        @foreach($ciudades as $ciudad)
                                            @if($ciudad->id_departamento == old('id_departamento', $cliente->id_departamento))
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="1" id="activo" name="activo" {{ old('activo', $cliente->activo) ? 'checked' : '' }}>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var clienteId = container.getAttribute('data-cliente-id');
    var clienteCiudadId = container.getAttribute('data-cliente-ciudad');
    window.ClienteManager.init(ciudadesData, clienteId, clienteCiudadId);
});
</script>
@endpush
@endsection
